...
(function(module) {
  ...
  //this function is a method attached to the newArtcle object to show tab-content, hide export-field, and select article-json on focus. Also, it calls newArticle.create on change, and newArticle.submit on submit.
